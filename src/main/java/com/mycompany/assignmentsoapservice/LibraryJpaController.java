...
import com.mycompany.assignmentsoapservice.exceptions.NonexistentEntityException;
import com.mycompany.assignmentsoapservice.exceptions.PreexistingEntityException;
...
public class LibraryJpaController implements Serializable {
    ...
    public void create(Library library) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findLibrary(library.getId()) != null) {
    ...
    public Library findLibrary(BigDecimal id) {
        EntityManager em = getEntityManager();
        try {
